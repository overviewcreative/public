...
class Agent_Form_Handler extends Form_Handler {
    ...
    public function handle_submission() {
        ...
        if (!empty($data['agent_bio'])) {
            $post_data['post_content'] = $data['agent_bio'];
        }
        ...
        if (!empty($data['agent_social_facebook'])) {
            update_post_meta($post_id, '_agent_facebook', $data['agent_social_facebook']);
        }
        
        if (!empty($data['agent_social_linkedin'])) {
            update_post_meta($post_id, '_agent_linkedin', $data['agent_social_linkedin']);
        }
